<template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <main class="container mx-auto px-4 py-8">
      ...
      <div
        v-if="error"
        class="bg-red-100 dark:bg-red-500 text-gray-900 dark:text-white p-4 rounded-lg mb-8"
      >
        {{ error }}
      </div>
      ...
      >
        ...
        >
          ...
          <div class="p-6">
            ...
            <p
              class="text-base leading-relaxed mb-4 text-gray-600 dark:text-gray-300"
            >
              {{ article.summary }}
            </p>
          ...
          <div class="p-8">
            ...
            <div class="bg-white dark:bg-gray-700 rounded-lg p-6 mb-6">
              ...
              <div
                ...
                class="text-lg space-y-4 text-gray-600 dark:text-gray-300"
              >
                <div
